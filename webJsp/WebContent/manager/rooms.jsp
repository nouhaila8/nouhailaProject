...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <div class="w3-third w3-margin-bottom">
      <img src="../images/im1.jpg" alt="Norway" style="width:100%">
      <div class="w3-container w3-white">
        <h3>Single Room</h3>
        <h6 class="w3-opacity">Price 500DH</h6>
        <p>Single bed</p>
        <p>15m<sup>2</sup></p>
        </div>
    </div>
    <div class="w3-third w3-margin-bottom">
      <img src="../images/im3.jpg" alt="Norway" style="width:100%">
      <div class="w3-container w3-white">
        <h3>Double Room</h3>
        <h6 class="w3-opacity">Price 1000DH</h6>
        <p>Queen-size bed</p>
        <p>25m<sup>2</sup></p>
        </div>
    </div>
    <div class="w3-third w3-margin-bottom">
      <img src="../images/im2.jpg" alt="Norway" style="width:100%">
      <div class="w3-container w3-white">
        <h3>Deluxe Room</h3>
        <h6 class="w3-opacity">Price 1000</h6>
        <p>King-size bed</p>
        <p>40m<sup>2</sup></p>
         </div>
    </div>
