...
<div class="tm-section tm-bg-img" id="tm-section-1">
      ...
      <form action="../ReserverARoom" method="post" class="tm-search-form tm-section-pad-2">
         <div class="form-row tm-search-form-row">
         <div class=class="form-group tm-form-element tm-form-element-50">
            <label><i ></i> Check In</label>
            <input class="form-control" type="date" placeholder="DD MM YYYY" name="CheckIn" required>
          </div>
          <div class=class="form-group tm-form-element tm-form-element-50">
            <label><i></i> Check Out</label>
        ...
        <div class="form-group tm-form-element tm-form-element-2">
            <label><i ></i> Adult</label>
            <input class="form-control tm-select" type="number" value="1" name="Adults" min="1" max="6">
          </div>
           <div class="form-group tm-form-element tm-form-element-2">
            <label><i ></i>Children</label>
          <input class="form-control tm-select" type="number" value="0" name="Kids" min="0" max="6">
